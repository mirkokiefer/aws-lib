...
exports.createEC2Client = function (accessKeyId, secretAccessKey) {
  var host = "ec2.eu-west-1.amazonaws.com";
  var path = "/";
...
exports.createProdAdvClient = function (accessKeyId, secretAccessKey, associateTag) {
...
var genericAWSClient = function(obj) {
  ...
  obj.connection = http.createClient(443, obj.host, true, creds);
  obj.call = function (action, query, callback) {
